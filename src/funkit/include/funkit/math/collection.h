...
// HorizontalDeadband represents an interval of "dead activity" where behavior should not be applied. 
// It returns an output that is scaled accordingly to the remaining length of the interval
double HorizontalDeadband(double input, double x_intercept, double max,
    double exponent = 1, double sensitivity = 1);

// VerticalDeadband represents an interval of "dead activity" where behavior should not be applied. 
// It returns an output that is scaled accordingly to the deadband
