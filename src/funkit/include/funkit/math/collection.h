...
// HorizontalDeadband represents an interval of "dead activity" where PID should not be applied. 
...
// VerticalDeadband represents an interval of "dead activity" where PID should not be applied. 
