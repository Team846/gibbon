...
#include "funkit/robot/swerve/aim_command.h"
#include "funkit/robot/swerve/drive_to_point_command.h"
#include "funkit/robot/swerve/lock_to_point_command.h"
...
#define DRIVE_TO_SOURCE(auto_name)                                       \
  frc2::ParallelDeadlineGroup {                                          \
    funkit::robot::swerve::DriveToPointCommand{&(container.drivetrain_), \
...
#define GO_IN_SOURCE(auto_name)                                    \
  frc2::ParallelDeadlineGroup {                                    \
    WAIT_FOR_PIECE(), funkit::robot::swerve::DriveToPointCommand { \
...
#define LOCK_TO_SOURCE()                                          \
  frc2::ParallelDeadlineGroup {                                   \
    WAIT_FOR_PIECE(), funkit::robot::swerve::LockToPointCommand { \
...
#define AIM(bearing)                                                     \
  funkit::robot::swerve::AimCommand {                                    \
