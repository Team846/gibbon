...
// funkit::math::Vector3D AntiTippingCalculator::elev_cg_position_{
//     robot_constants::elevator::pos_x, robot_constants::elevator::pos_y,
//     robot_constants::base::height};
// funkit::math::Vector3D AntiTippingCalculator::tele_cg_position_{
...
//   funkit::math::uVec<units::feet_per_second, 2> v_neg_dir =
//       vel_vec.rotate(180_deg, true).unit();

//   funkit::math::Vector3D robot_cg = CalculateRobotCG();
...
//   funkit::math::Vector2D wheel_vecs[4];

//   for (size_t i = 0; i < 4; i++) {
//     wheel_vecs[i] =
//         funkit::math::Vector2D{
...
//   funkit::math::Vector2D closest_wheel = wheel_vecs[closest_wheel_vec];

//   funkit::math::Vector2D effective_wheel_vec =
//       v_neg_dir.projectOntoThis<units::inch>(closest_wheel);
//   funkit::math::Vector3D effective_wheel_vec_3d{
//       effective_wheel_vec[0], effective_wheel_vec[1], 0_in};

//   funkit::math::Vector3D r_vec = robot_cg - effective_wheel_vec_3d;

//   units::feet_per_second_squared_t perm_accel_x =
//       funkit::math::constants::physics::g * r_vec[0] / r_vec[2];
//   units::feet_per_second_squared_t perm_accel_y =
//       funkit::math::constants::physics::g * r_vec[1] / r_vec[2];
