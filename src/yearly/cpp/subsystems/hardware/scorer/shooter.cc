...
//       esc_1_{base::TALON_FX_KRAKENX60, ports::shooter_::kMotor1Params},
//       esc_2_{base::TALON_FX_KRAKENX60, ports::shooter_::kMotor2Params} {
...
//       ports::shooter_::kMotor1Params.can_id, true};
...
//   bool ok = true;
//   FUNKIT_VERIFY(esc_1_.VerifyConnected(), ok, "Could not verify shooter esc
//   1"); FUNKIT_VERIFY(esc_2_.VerifyConnected(), ok, "Could not verify shooter
//   esc 2"); return ok;
// }
